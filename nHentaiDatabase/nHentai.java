...
public class nHentai {
	...
	private void initialize(){
		...
		*/
		...
		model = new DefaultTableModel(
				...
				new String[] {
					"number", "title picture", "id", "title", "author", "pages", "status", ""
				}
			);
		table_panel1.setModel(model);
		table_panel1.getColumn(table_panel1.getColumnName(7)).setCellRenderer(
                new ButtonColumn());
		table_panel1.getColumn(table_panel1.getColumnName(7)).setCellEditor(
                new ButtonColumn());
		...
		*/
		...
		modelReading = new DefaultTableModel(
				new Object[][] {
					
  				},
				new String[] {
					"number", "title picture", "id", "title", "author", "pages", "rating", "status", ""
				}
			);
		table_panel2.setModel(modelReading);
		table_panel2.getColumn(table_panel2.getColumnName(8)).setCellRenderer(
                new ButtonColumnReading());
		table_panel2.getColumn(table_panel2.getColumnName(8)).setCellEditor(
                new ButtonColumnReading());
	...
	public DefaultTableModel nHentaiAPIRun(String code, String URL, String rating, String status){
		String coverImage = "";
		String title = "";
		String id = "";
		...
		nHentaiAPI.saveImageAsFile(coverImage, appdataLocation + mainFolderLocation + photoFolderLocation + "\\" + id + "_original.jpg");
		scaleImage(appdataLocation + mainFolderLocation + photoFolderLocation + "\\" + id, "_low.jpg", 50, 71);
		scaleImage(appdataLocation + mainFolderLocation + photoFolderLocation + "\\" + id, "_medium.jpg", 150, 212);
	...
	public DefaultTableModel nHentaiAPIRunReading(String code, String URL, String rating, String status){
		String coverImage = "";
		String title = "";
		String id = "";
		String[] tags = new String[0];
		...
		return expandTableReading(modelReading, id);
	}
    ...
    public ButtonColumn(){
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	...
            	JOptionPane inspectPane = new JOptionPane(moreInformation, JOptionPane.PLAIN_MESSAGE, JOptionPane.OK_OPTION);
            	int result = inspectPane.showOptionDialog(null, moreInformation, "settings", 0, JOptionPane.PLAIN_MESSAGE, null, null, null);
